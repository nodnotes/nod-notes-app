...
import { blockGripChromeScale } from '@/lib/frame-adjust-box' // Same √ curve as TipTap ⋮⋮
...
export function IBarFlowAnchor({
  ...
  const paneScale = scaleZoom * blockGripChromeScale(scaleZoom, 1) // I-bar has no frameScale yet
