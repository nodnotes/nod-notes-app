...
export function WelcomeText() {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-[5] select-none">
      <div className="text-center w-full max-w-3xl px-4 select-none" style={{ WebkitUserSelect: 'none', WebkitTouchCallout: 'none' }}>
        {isMounted ? (
          <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4 animate-in fade-in duration-500 select-none">
