    ...
    <li ref={setNodeRef} style={style} data-id={conversation.id}>
      ...
      <div
        ...
        className={cn(
          ...
          isActive
            ? 'bg-[var(--nod-selected)]' // Open board — grey wash on white nav shell
    ...
    <li ref={setNodeRef} className="space-y-0" data-id={projectDragOverId}>
      ...
      <div
        ...
        className={cn(
          ...
          isActive
            ? 'bg-[var(--nod-selected)] text-gray-700 dark:text-gray-300 border-transparent'
            : isDragOver
              ? 'bg-[var(--nod-selected)] text-gray-700 dark:text-gray-300 border-blue-500 dark:border-blue-400 border-dashed'
              : 'hover:bg-[var(--nod-tab-hover)] text-gray-700 dark:text-gray-300 border-transparent'
        )}
        onContextMenu={(e) => {
          e.preventDefault()
          e.stopPropagation()
        ...
        {!isCollapsed && (
          <nav className="flex-1 min-h-0 px-4 pb-4 overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-400/50 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:hover:bg-gray-400/70 dark:[&::-webkit-scrollbar-thumb]:bg-gray-500/50 dark:[&::-webkit-scrollbar-thumb]:hover:bg-gray-500/70 [&::-webkit-scrollbar]:bg-transparent">
            ...
            >
              ...
              <DragOverlay>
                {activeId ? (
                  <div className="flex items-center gap-2 px-4 h-8 rounded-lg bg-[var(--nod-selected)] text-sm shadow-lg opacity-90 cursor-grabbing">
