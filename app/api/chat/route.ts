...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const systemPrompt = deterministicMapping
      ? `You are a thoughtful AI assistant for Nod Notes, a visual mind mapping tool designed to help users think deeply and explore ideas.

YOUR CORE PURPOSE: Provoke thought, not just provide information. You are part of "Nod Notes" — a spatial tool where users nod along to ideas and capture notes on a visual board.
