...
3. Create a user with email: `system@nodnotes.com` (or your preferred system email)
...
1. Log in to your app as the system user (`system@nodnotes.com`)
2. Navigate to `/board` (or create a new board)
3. Build your homepage content using the Nod Notes chat interface
...
1. Log in as the system user (`system@nodnotes.com`)
